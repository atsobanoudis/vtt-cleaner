...
> [!NOTE]
> This was built specifically using MS Teams output. VTT formats from other sources (e.g., Zoom) might require small regex adjustments to handle different speaker tag styles
